...
const atualizarPizza = async function (pizza) {
    ...
    {
        //import da model de pizza
        const atualizarPizza = require('../model/model_pizza.js');
...
const excluirPizza = async function (id) {
    ...
    if (id == ''|| id == undefined)
        ...
        {
            //import da model de Pizza
            const excluirPizza = require('../model/model_pizza.js');
...
const listarPizzas = async function () {
    ...
    const { selectAllPizzas } = require ('../model/model_pizza.js');
...
const buscarPizza = async function (id) {
    ...
    if (id == ''|| id == undefined)
        ...
        const { selectByIdPizza } = require ('../model/model_pizza.js');
